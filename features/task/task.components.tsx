                    ...
                    if (item.submenu) {
                      return (
                        ...
                        >
                          ...
                          <div
                            className={`absolute left-full top-0.5 z-[10000] ml-2 w-28 overflow-hidden rounded-2xl border bg-popover/92 p-1 shadow-lg backdrop-blur-sm ring-1 ring-foreground/12 transition-all duration-100 ${
                    ...
                    if (item.confirm) {
                      return (
                        <div key={item.id} className="relative">
                          ...
                          />
                          <div
                            className={`absolute left-full top-0 z-[10001] ml-2 w-56 rounded-2xl border bg-popover/95 p-2 shadow-lg backdrop-blur-sm ring-1 ring-foreground/12 transition-all duration-100 ${
                          ...
                          >
                            ...
                            <div className="mt-2 flex items-center justify-end gap-2">
                              <button
                                className="inline-flex items-center gap-1 rounded-lg border border-border px-2 py-1 text-xs transition-colors hover:bg-muted"
                              ...
                              <button
                                className="inline-flex items-center gap-1 rounded-lg border border-destructive/40 px-2 py-1 text-xs text-destructive transition-colors hover:bg-destructive/10"
                                onClick={() => {
                                  item.onClick?.();
                                  setConfirmOpenId(null);
                                }}
